...
df = pd.read_csv("data/mini-set.csv")
...
ax.xaxis.set_ticklabels(['Modell: gesund', 'Modell: krank'], fontsize = 15)
ax.xaxis.tick_top()

ax.set_ylabel('Reality', fontsize=20)
ax.yaxis.set_ticklabels(['R: gesund', 'R: krank'], fontsize = 15)
plt.show()
